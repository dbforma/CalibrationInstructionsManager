...
//
//         public DelegateCommand<object> SelectedTemplateCommand { get; set; }
//         public DelegateCommand<MeasurementPointTemplate> PassItemCommand { get; }
//
//         private readonly IMeasurementPointsOverviewService _overviewService;
//
//         /// <summary>
//         /// Filter logic for search bar
//         /// </summary>
...
//         #endregion // Properties & Commands
//
//         public MeasurementPointsOverviewViewModel(IPostgresql database, IRegionManager regionManager, IMeasurementPointsOverviewService overviewService)
//         {
//             _database = database;
//             _regionManager = regionManager;
...
//             SelectedTemplateCommand = new DelegateCommand<object>(checkSelectedItem);
//             MeasurementPointTemplates = new ObservableCollection<IMeasurementPointTemplate>(database.GetMeasurementPointTemplates().ToList());
//             PassItemCommand = new DelegateCommand<MeasurementPointTemplate>(PassSelectedItemToService);
//         }
//
//         #region Methods
//
...
//         private void PassSelectedItemToService(MeasurementPointTemplate selectedItem)
//         {
...
//         {
//             MeasurementPointCollectionView = CollectionViewSource.GetDefaultView(_measurementPointTemplates);
...
//         {
//             _overviewService.GetTemplates(MeasurementPointTemplates);
//         }
//
//         #endregion // Methods
//     }
